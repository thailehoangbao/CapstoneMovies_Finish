...
import { actFetchEditFilm } from './duckEditFilm/actEditFilm';
import { actFetchUpdateFilm } from './duckEditFilm/actUpdateFilm';
...
export default function EditFilm() {
    ...
    const filmEdit = useSelector(state => state.editFilmAdminReducer.data);

    // console.log(filmEdit, "filmEdit");
    useEffect(() => {
        const maPhim = params.id*1;
        console.log(maPhim);

        dispatch(actFetchEditFilm(maPhim));
    }, []);
    ...
    return (
        ...
        >
            ...
            <Form.Item label="Hành Động">
                <button className='p-2 bg-slate-500 text-white rounded-md' onChange={formik.handleSubmit}>Update Phim</button>
            </Form.Item>
        </Form>
    )
}
